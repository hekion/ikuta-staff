document.addEventListener("DOMContentLoaded", function() {
    ...
    <footer class="site-footer">
        ...
        <div class="footer-content">
            <div class="footer-grid">
                ...
                <div class="footer-section">
                    ...
                    <ul class="facility-list">
                        <li><span class="fac-name">フロンタウン生田</span>
                            <div class="fac-links">
                        ...
                        <li><span class="fac-name">フロンタウンさぎぬま</span>
                            <div class="fac-links">
                        ...
                        <li><span class="fac-name">富士通スタジアム川崎</span>
                            <div class="fac-links">
                        ...
                        <li><span class="fac-name">富士見公園</span>
                            <div class="fac-links">
            ...
            <div class="footer-bottom"><p class="copyright">&copy; 2026 FRONTOWN IKUTA</p></div>
        </div>
    </footer>`;
